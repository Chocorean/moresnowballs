...
public class RenderCustomSnowball extends Render<EntityCustomSnowball> {
    private final ModelSnowball model = new ModelSnowball();

    public RenderCustomSnowball(RenderManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void doRender(EntityCustomSnowball entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityCustomSnowball entity) {
        return new ResourceLocation(MoreSnowballsMod.MODID,"textures/items/snowball.png");
    }
}