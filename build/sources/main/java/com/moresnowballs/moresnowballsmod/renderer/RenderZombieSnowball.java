...
public class RenderZombieSnowball extends Render<EntityZombieSnowball> {
    private final ModelSnowball model = new ModelSnowball();

    public RenderZombieSnowball(RenderManager renderManagerIn) {
        super(renderManagerIn);
    }

    @Override
    public void doRender(EntityZombieSnowball entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityZombieSnowball entity) {
        return new ResourceLocation(MoreSnowballsMod.MODID,"textures/items/zombie_snowball.png");
    }
}