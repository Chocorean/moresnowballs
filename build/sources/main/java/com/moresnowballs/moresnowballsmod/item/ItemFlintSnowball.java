...
public class ItemFlintSnowball extends SnowballBase {
    public ItemFlintSnowball(String name) {
        super(name);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (!worldIn.isRemote)
        {
            EntityFlintSnowball entitysnowball = new EntityFlintSnowball(worldIn, playerIn);
